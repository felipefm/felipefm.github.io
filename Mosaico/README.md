...
Vivemos em um tempo onde a informação flui como um rio caudaloso. Às vezes, queremos apenas mergulhar em um único vídeo. Outras vezes, queremos observar a correnteza inteira.

O **Mosaico YouTube** não é apenas um reprodutor de vídeos; é uma ferramenta de curadoria. É o seu painel de controle pessoal para monitorar o mundo, assistir a múltiplos eventos simultâneos ou simplesmente criar uma atmosfera sonora e visual única.

Seja para acompanhar as notícias de diferentes fontes, monitorar o mercado, ou assistir aos seus streamers favoritos ao mesmo tempo, aqui você é o maestro.
...
Este projeto foi construído com a privacidade em mente.
* **Sem Rastros:** Não há servidores observando você.
* **Local:** Suas listas, chaves e preferências ficam salvas apenas no seu dispositivo (Navegador).
* **Transparente:** O código é aberto, como um livro que todos podem ler.
